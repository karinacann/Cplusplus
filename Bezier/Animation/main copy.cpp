...
std::unique_ptr<Framebuffer> fb; //this makes pointers a bit safer
std::unique_ptr<RGBA8Texture> c_buf;
///
///want ot create frame buffer
///

//note: frame bffers are nice because it helps you do some post processing effects
int main(int, char**){
    ...
    Window& window = app.create_window([](Window&){
        glViewport(0,0,width,height);
            ...
            ///before we do draw commands we want to bind the frame bin
